...
#define ORIGINAL_FILE_NAME "UE4Editor-HyperFighters2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME HyperFighters2
#define DEPRECATED_FORGAME DEPRECATED
#define HYPERFIGHTERS2_API DLLEXPORT
